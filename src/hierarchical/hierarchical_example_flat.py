from hierarchical_state_flat import *
...
def hierarchical_example():
    ...
    falkor_state = FalkorState(time_remains=10, region_types=region_types, region_states=region_states)
